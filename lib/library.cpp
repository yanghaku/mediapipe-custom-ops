...
void wasmEdgeWasiNnTfLiteAddCustomOps(TfLiteInterpreterOptions *options) {
    ...
    //                                     mediapipe::tflite_operations::RegisterTransformTensorBilinearV1(),
    //                                     1, 1);
    ...
    //                                     mediapipe::tflite_operations::RegisterTransformLandmarksV1(),
    //                                     1, 1);
    // TfLiteInterpreterOptionsAddCustomOp(options, "TransformLandmarks",
    ...
    // TfLiteInterpreterOptionsAddCustomOp(options, "NGramHash",
    // mediapipe::tflite_operations::Register_NGRAM_HASH(), 1,
    //                                     1);
